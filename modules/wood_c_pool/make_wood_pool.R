...
make_wood_pool <- function(ring_area){
    ...
    source("download_diameter_data.R")
    ...
    classif <- read.csv("FACE_AUX_RA_TREE-DESCRIPTIONS_R_20130201.csv",stringsAsFactors = FALSE)
    ...
    source("make_sapwood_c_n_fraction.R")
