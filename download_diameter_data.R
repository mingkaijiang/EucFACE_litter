...
download_diameter_data <- function() {
    ...
    infile10 <- "FACE_P0025_RA_TREEMEAS_2017_RAW_V1.csv"
    infile11 <- "FACE_P0025_RA_TREEMEAS_2018_RAW_V1.csv"
    ...
    downloadHIEv(hiev=searchHIEv(infile10))
    downloadHIEv(hiev=searchHIEv(infile11))
